# Generated by Django 3.2 on 2021-04-21 22:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='statuses', to='store.order', verbose_name='Order')),
            ],
            options={
